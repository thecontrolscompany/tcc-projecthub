...
export const FCU_COMPS = [
  { id: "fcu-ctrl", groupId: "fcu-controller", emtAID: "60090", plnAID: "60034", name: "FCU Controller", cat: "Controls", controlsId: null, def: false,
    defaultWhen: () => true, desc: "DDC fan coil controller" },
  { id: "fcu-tec", groupId: "fcu-controller", emtAID: "60119", plnAID: "60119", name: "FCU Stat Controller", cat: "Controls", controlsId: null, def: false,
    desc: "Thermostat combo stat controller (TEC)" },
  { id: "fcu-chw-vlv", groupId: "fcu-cooling-actuator", emtAID: "60077", plnAID: "60077", name: "CHW Valve - Proportional", cat: "Actuators", controlsId: "CTL-DEV-ACT-VALVE-MOD", def: false,
  ...
  { id: "fcu-chw-vlv-incr", groupId: "fcu-cooling-actuator", emtAID: "60147", plnAID: "60096", name: "CHW Valve - Incremental", cat: "Actuators", controlsId: "CTL-DEV-ACT-VALVE-2POS", def: false,
  ...
  { id: "fcu-chw-vlv-2pos", groupId: "fcu-cooling-actuator", emtAID: "60077", plnAID: "60077", name: "CHW Valve - Two-Position", cat: "Actuators", controlsId: "CTL-DEV-ACT-VALVE-2POS", def: false,
  ...
  { id: "fcu-clg-staged", emtAID: "60106", plnAID: "60106", name: "Staged Cooling Output(s)", cat: "Actuators", controlsId: "CTL-DEV-STAGE-RELAY", def: false,
  ...
  { id: "fcu-hw-vlv", groupId: "fcu-heating-actuator", emtAID: "60077", plnAID: "60077", name: "HW Valve - Proportional", cat: "Actuators", controlsId: "CTL-DEV-ACT-VALVE-MOD", def: false,
  ...
  { id: "fcu-hw-vlv-incr", groupId: "fcu-heating-actuator", emtAID: "60147", plnAID: "60096", name: "HW Valve - Incremental", cat: "Actuators", controlsId: "CTL-DEV-ACT-VALVE-2POS", def: false,
  ...
  { id: "fcu-hw-vlv-2pos", groupId: "fcu-heating-actuator", emtAID: "60077", plnAID: "60077", name: "HW Valve - Two-Position", cat: "Actuators", controlsId: "CTL-DEV-ACT-VALVE-2POS", def: false,
  ...
  { id: "fcu-htg-staged", emtAID: "60107", plnAID: "60107", name: "Staged Heating Output(s)", cat: "Actuators", controlsId: "CTL-DEV-STAGE-RELAY", def: false,
  ...
  { id: "fcu-cmn-vlv-prop", groupId: "fcu-common-coil-actuator", emtAID: "60077", plnAID: "60077", name: "Common Coil Valve - Proportional", cat: "Actuators", controlsId: "CTL-DEV-ACT-VALVE-MOD", def: false,
  ...
  { id: "fcu-cmn-vlv-incr", groupId: "fcu-common-coil-actuator", emtAID: "60147", plnAID: "60096", name: "Common Coil Valve - Incremental", cat: "Actuators", controlsId: "CTL-DEV-ACT-VALVE-2POS", def: false,
  ...
  { id: "fcu-cmn-vlv-2pos", groupId: "fcu-common-coil-actuator", emtAID: "60077", plnAID: "60077", name: "Common Coil Valve - Two-Position", cat: "Actuators", controlsId: "CTL-DEV-ACT-VALVE-2POS", def: false,
  ...
  { id: "fcu-rm-t", emtAID: "60082", plnAID: "60032", name: "Room Temp Sensor", cat: "Temperature", controlsId: "CTL-DEV-TEMP-SPACE", def: false,
    defaultWhen: () => true, desc: "Wall-mount room temp sensor" },
  { id: "fcu-da-t", emtAID: "60073", plnAID: "60037", name: "Discharge Air Temp", cat: "Temperature", controlsId: "CTL-DEV-TEMP-DUCT", def: false,
    defaultWhen: () => true, desc: "Discharge air temp after coil" },
  { id: "fcu-filter", emtAID: "60059", plnAID: "60059", name: "Filter DP Switch", cat: "Pressure", controlsId: "CTL-DEV-PRESS-FILTER", def: false,
    defaultWhen: () => true, desc: "Differential pressure switch across FCU filter" },
  { id: "fcu-fan-cs", emtAID: "60061", plnAID: "60061", name: "Fan Current Switch", cat: "Safety", controlsId: "CTL-DEV-FAN-STATUS", def: false,
    showWhen: cfg => normalizeFcuCfg(cfg).fanType !== "by-others",
    desc: "Current switch for fan proof of operation" },
  { id: "fcu-fan-spd-adj", emtAID: "60129", plnAID: "60129", name: "Fan Speed Adjust", cat: "Controls", controlsId: null, def: false,
    showWhen: cfg => normalizeFcuCfg(cfg).fanType === "three-speed",
    desc: "3-speed fan adjustment point" },
  { id: "fcu-rh", emtAID: "60066", plnAID: "60066", name: "Room Humidity", cat: "Humidity", controlsId: "CTL-DEV-HUMID-DUCT", def: false,
    desc: "Wall-mount room humidity sensor" },
  { id: "fcu-ddc", emtAID: "60087", plnAID: "60087", name: "DDC Control Panel", cat: "Controls", controlsId: null, def: false,
    desc: "Field DDC panel - BACnet" },
  { id: "fcu-pwr-trunk", emtAID: "60135", plnAID: "60052", name: "24V Power Trunk", cat: "Controls", controlsId: null, def: false,
    defaultWhen: () => true, desc: "24VAC transformer + power trunk to DDC controllers", wire: "-" },
  { id: "fcu-homerun", emtAID: "60016", plnAID: "60016", name: "Home Run Conduit", cat: "Wiring", controlsId: null, def: false,
    defaultWhen: () => true, desc: "EMT home run to main panel", wire: "-" },
  { id: "fcu-condensate", emtAID: "60070", plnAID: "60070", name: "Condensate Alarm", cat: "Safety", controlsId: "CTL-DEV-CONDENSATE", def: false,
    showWhen: cfg => {
      const next = normalizeFcuCfg(cfg);
      return next.coolingType !== "none" || next.commonCoilType !== "none";
    },
    desc: "Condensate alarm input" },
  { id: "fcu-sw-switch", emtAID: "60070", plnAID: "60070", name: "Summer-Winter Switch", cat: "Controls", controlsId: null, def: false,
    showWhen: cfg => normalizeFcuCfg(cfg).commonCoilType !== "none",
    desc: "2-pipe summer/winter changeover switch" },
  { id: "fcu-lighting-rly", emtAID: "60070", plnAID: "60070", name: "Lighting Relay", cat: "Controls", controlsId: null, def: false,
    desc: "Lighting relay / occupied input interface" },
  { id: "fcu-occ-sensor", emtAID: "60082", plnAID: "60032", name: "Zone Occupancy Sensor", cat: "Controls", controlsId: null, def: false,
    desc: "Occupancy input for scheduled control sequences" },
  { id: "fcu-unit-enable", emtAID: "60070", plnAID: "60070", name: "Unit Enable Switch", cat: "Controls", controlsId: null, def: false,
    desc: "Network unit enable input" },
  { id: "fcu-energy-ho", emtAID: "60070", plnAID: "60070", name: "Energy Hold-Off Switch", cat: "Controls", controlsId: null, def: false,
    desc: "Network energy hold-off input" },
  { id: "fcu-smoke", emtAID: "60122", plnAID: "60122", name: "Discharge Air Smoke Detector", cat: "Safety", controlsId: "CTL-DEV-SMOKE", def: false,
