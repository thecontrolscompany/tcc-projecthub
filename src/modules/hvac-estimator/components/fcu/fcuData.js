...
export const FCU_COMPS = [
  ...
  { id: "fcu-chw-vlv", groupId: "fcu-cooling-actuator", emtAID: "60077", plnAID: "60077", name: "CHW Valve - Proportional", cat: "Actuators", controlsId: "CTL-AO", def: false,
  ...
  { id: "fcu-chw-vlv-incr", groupId: "fcu-cooling-actuator", emtAID: "60147", plnAID: "60096", name: "CHW Valve - Incremental", cat: "Actuators", controlsId: "CTL-BO", def: false,
  ...
  { id: "fcu-chw-vlv-2pos", groupId: "fcu-cooling-actuator", emtAID: "60077", plnAID: "60077", name: "CHW Valve - Two-Position", cat: "Actuators", controlsId: "CTL-BO", def: false,
  ...
  { id: "fcu-clg-staged", emtAID: "60106", plnAID: "60106", name: "Staged Cooling Output(s)", cat: "Actuators", controlsId: "CTL-BO", def: false,
  ...
  { id: "fcu-hw-vlv", groupId: "fcu-heating-actuator", emtAID: "60077", plnAID: "60077", name: "HW Valve - Proportional", cat: "Actuators", controlsId: "CTL-AO", def: false,
  ...
  { id: "fcu-hw-vlv-incr", groupId: "fcu-heating-actuator", emtAID: "60147", plnAID: "60096", name: "HW Valve - Incremental", cat: "Actuators", controlsId: "CTL-BO", def: false,
  ...
  { id: "fcu-hw-vlv-2pos", groupId: "fcu-heating-actuator", emtAID: "60077", plnAID: "60077", name: "HW Valve - Two-Position", cat: "Actuators", controlsId: "CTL-BO", def: false,
  ...
  { id: "fcu-htg-staged", emtAID: "60107", plnAID: "60107", name: "Staged Heating Output(s)", cat: "Actuators", controlsId: "CTL-BO", def: false,
  ...
  { id: "fcu-cmn-vlv-prop", groupId: "fcu-common-coil-actuator", emtAID: "60077", plnAID: "60077", name: "Common Coil Valve - Proportional", cat: "Actuators", controlsId: "CTL-AO", def: false,
  ...
  { id: "fcu-cmn-vlv-incr", groupId: "fcu-common-coil-actuator", emtAID: "60147", plnAID: "60096", name: "Common Coil Valve - Incremental", cat: "Actuators", controlsId: "CTL-BO", def: false,
  ...
  { id: "fcu-cmn-vlv-2pos", groupId: "fcu-common-coil-actuator", emtAID: "60077", plnAID: "60077", name: "Common Coil Valve - Two-Position", cat: "Actuators", controlsId: "CTL-BO", def: false,
  ...
  { id: "fcu-rm-t", emtAID: "60082", plnAID: "60032", name: "Room Temp Sensor", cat: "Temperature", controlsId: "CTL-AI", def: false,
    defaultWhen: () => true, desc: "Wall-mount room temp sensor" },
  { id: "fcu-da-t", emtAID: "60073", plnAID: "60037", name: "Discharge Air Temp", cat: "Temperature", controlsId: "CTL-AI", def: false,
    defaultWhen: () => true, desc: "Discharge air temp after coil" },
  { id: "fcu-filter", emtAID: "60059", plnAID: "60059", name: "Filter DP Switch", cat: "Pressure", controlsId: "CTL-AI", def: false,
    defaultWhen: () => true, desc: "Differential pressure switch across FCU filter" },
  { id: "fcu-fan-cs", emtAID: "60061", plnAID: "60061", name: "Fan Current Switch", cat: "Safety", controlsId: "CTL-BI", def: false,
  ...
  { id: "fcu-rh", emtAID: "60066", plnAID: "60066", name: "Room Humidity", cat: "Humidity", controlsId: "CTL-AI", def: false,
  ...
  { id: "fcu-condensate", emtAID: "60070", plnAID: "60070", name: "Condensate Alarm", cat: "Safety", controlsId: "CTL-BI", def: false,
    showWhen: cfg => {
      const next = normalizeFcuCfg(cfg);
  ...
  { id: "fcu-smoke", emtAID: "60122", plnAID: "60122", name: "Discharge Air Smoke Detector", cat: "Safety", controlsId: "CTL-BI", def: false,
