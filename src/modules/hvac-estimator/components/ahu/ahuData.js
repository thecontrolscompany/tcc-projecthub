...
export const AHU_COMPS = [
  ...
  withLegacyArrays(
    { id: "ddc-panel", emtAID: "60087", plnAID: "60087", name: "DDC Control Panel", cat: "Controls", controlsId: null, unitMtl: 1850, unitLbr: 8.0,
      showWhen: () => true, defaultWhen: () => true, desc: "Field DDC panel - BACnet MS/TP or IP" },
    A, A
  ),
  withLegacyArrays(
    { id: "uv-light", emtAID: "60123", plnAID: "60123", name: "UV Light Section", cat: "Controls", controlsId: null, unitMtl: 485, unitLbr: 2.0,
      showWhen: () => true, desc: "UV-C germicidal section with I/O" },
    A, []
  ),
  withLegacyArrays(
    { id: "pwr-trunk", emtAID: "60135", plnAID: "60052", name: "24V Power Trunk", cat: "Controls", controlsId: null, unitMtl: 285, unitLbr: 2.0,
      showWhen: () => true, defaultWhen: () => true, desc: "24VAC transformer + power trunk to DDC controllers", wire: "-" },
    A, A
  ),
  withLegacyArrays(
    { id: "homerun", emtAID: "60016", plnAID: "60016", name: "Home Run Conduit", cat: "Wiring", controlsId: null, unitMtl: 185, unitLbr: 2.0,
