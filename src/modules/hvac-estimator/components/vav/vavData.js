...
export const VAV_COMPS = [
  ...
  { id:"vav-act-incr", groupId:"vav-actuator-type", emtAID:"60147", plnAID:"60096", name:"Damper Actuator - Incremental", cat:"Actuators", controlsId: "CTL-DEV-ACT-DAMPER-2POS", unitMtl:325, unitLbr:1.9, sym:"INC", def:false,
  ...
  { id:"flow-sensor", emtAID:"60060", plnAID:"60028", name:"Flow/Velocity Sensor",    cat:"Pressure", controlsId: "CTL-DEV-PRESS-FLOW",    unitMtl:185, unitLbr:1.0,  sym:"DP",  def:false,
    pos:{x:58,y:168},  anc:{x:128,y:202}, desc:"Differential pressure pickup at inlet" },
  { id:"zn-temp",     emtAID:"60082", plnAID:"60032", name:"Zone Temp Sensor",        cat:"Temperature", controlsId: "CTL-DEV-TEMP-SPACE", unitMtl:125, unitLbr:0.75, sym:"T",   def:true,
    pos:{x:490,y:52},  anc:{x:490,y:178}, desc:"Wall-mount temp sensor in zone" },
  { id:"zn-co2",      emtAID:"60082", plnAID:"60032", name:"Zone Temp + CO2",         cat:"Air Quality", controlsId: "CTL-DEV-TEMP-CO2", unitMtl:345, unitLbr:0.75, sym:"T+C", def:false,
    pos:{x:570,y:52},  anc:{x:490,y:178}, desc:"Combination temp + CO2 wall sensor" },
  { id:"elec-heat",   emtAID:"60108", plnAID:"60040", name:"Electric Heat Stages",    cat:"Actuators", controlsId: "CTL-DEV-STAGE-RELAY",   unitMtl:225, unitLbr:2.0,  sym:"EH",  def:false,
    showWhen: cfg => normalizeVavCfg(cfg).heatType === "electric",
    pos:{x:444,y:300}, anc:{x:445,y:248}, desc:"Electric reheat staging control" },
  { id:"rh-valve",    groupId:"reheat-actuator", emtAID:"60081", plnAID:"60033", name:"Reheat Valve - Proportional", cat:"Actuators", controlsId: "CTL-DEV-ACT-VALVE-MOD", unitMtl:265, unitLbr:1.5, sym:"V", def:false,
  ...
  { id:"rh-valve-2pos", groupId:"reheat-actuator", emtAID:"60089", plnAID:"60035", name:"Reheat Valve - Two-Position", cat:"Actuators", controlsId: "CTL-DEV-ACT-VALVE-2POS", unitMtl:235, unitLbr:1.25, sym:"2P", def:false,
    showWhen: cfg => normalizeVavCfg(cfg).heatType === "valve",
    pos:{x:444,y:300}, anc:{x:445,y:248}, desc:"Two-position hot water reheat valve actuator" },
  { id:"rh-valve-incr", groupId:"reheat-actuator", emtAID:"60081", plnAID:"60033", name:"Reheat Valve - Incremental", cat:"Actuators", controlsId: "CTL-DEV-ACT-VALVE-2POS", unitMtl:265, unitLbr:1.5, sym:"INC", def:false,
    showWhen: cfg => normalizeVavCfg(cfg).heatType === "valve",
    pos:{x:478,y:300}, anc:{x:510,y:248}, desc:"Incremental hot water reheat valve actuator" },
  { id:"disch-temp",  emtAID:"60093", plnAID:"60037", name:"Discharge Air Temp",      cat:"Temperature", controlsId: "CTL-DEV-TEMP-DUCT", unitMtl:125, unitLbr:0.75, sym:"T",   def:true,
