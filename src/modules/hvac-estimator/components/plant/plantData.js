...
export const PLANT_COMPS = {
  ...
  "chiller-air": [
    ...
    { id:"ach-chw-sup",  emtAID:"60076", plnAID:"60076", name:"CHW Supply Temp",           cat:"Temperature", controlsId: "CTL-DEV-TEMP-PIPE", def:true,  desc:"Chilled water supply temp sensor" },
    { id:"ach-chw-ret",  emtAID:"60076", plnAID:"60076", name:"CHW Return Temp",           cat:"Temperature", controlsId: "CTL-DEV-TEMP-PIPE", def:true,  desc:"Chilled water return temp sensor" },
    { id:"ach-iso-vlv",  emtAID:"60114", plnAID:"60114", name:"Isolation Valve",           cat:"Actuators", controlsId: "CTL-DEV-ACT-ISO-VALVE",   def:true,  desc:"CHW isolation valve with end switch" },
    { id:"ach-flow",     emtAID:"60152", plnAID:"60152", name:"Flow Meter",                cat:"Pressure", controlsId: "CTL-DEV-FLOW-METER",    def:false, desc:"Insertion flow meter in CHW piping" },
  ...
  "chiller-water": [
    ...
    { id:"wch-chw-sup",  emtAID:"60076", plnAID:"60076", name:"CHW Supply Temp",           cat:"Temperature", controlsId: "CTL-DEV-TEMP-PIPE", def:true,  desc:"Chilled water supply temp sensor" },
    { id:"wch-chw-ret",  emtAID:"60076", plnAID:"60076", name:"CHW Return Temp",           cat:"Temperature", controlsId: "CTL-DEV-TEMP-PIPE", def:true,  desc:"Chilled water return temp sensor" },
    { id:"wch-cond-sup", emtAID:"60076", plnAID:"60076", name:"Condenser Supply Temp",     cat:"Temperature", controlsId: "CTL-DEV-TEMP-PIPE", def:true,  desc:"Condenser water supply temp" },
    { id:"wch-cond-ret", emtAID:"60076", plnAID:"60076", name:"Condenser Return Temp",     cat:"Temperature", controlsId: "CTL-DEV-TEMP-PIPE", def:true,  desc:"Condenser water return temp" },
    { id:"wch-iso-vlv",  emtAID:"60114", plnAID:"60114", name:"CHW Isolation Valve",       cat:"Actuators", controlsId: "CTL-DEV-ACT-ISO-VALVE",   def:true,  desc:"CHW isolation valve with end switch" },
    { id:"wch-flow",     emtAID:"60152", plnAID:"60152", name:"Flow Meter",                cat:"Pressure", controlsId: "CTL-DEV-FLOW-METER",    def:false, desc:"Insertion flow meter in CHW piping" },
  ...
  "boiler-hw": [
    ...
    { id:"bhw-sup-t",    emtAID:"60076", plnAID:"60076", name:"HW Supply Temp",            cat:"Temperature", controlsId: "CTL-DEV-TEMP-PIPE", def:true,  desc:"Hot water supply temp sensor" },
    { id:"bhw-ret-t",    emtAID:"60076", plnAID:"60076", name:"HW Return Temp",            cat:"Temperature", controlsId: "CTL-DEV-TEMP-PIPE", def:true,  desc:"Hot water return temp sensor" },
    { id:"bhw-iso-vlv",  emtAID:"60114", plnAID:"60114", name:"Isolation Valve",           cat:"Actuators", controlsId: "CTL-DEV-ACT-ISO-VALVE",   def:false, desc:"HW isolation valve with end switch" },
    { id:"bhw-flow",     emtAID:"60152", plnAID:"60152", name:"Flow Meter",                cat:"Pressure", controlsId: "CTL-DEV-FLOW-METER",    def:false, desc:"Insertion flow meter in HW piping" },
  ...
  "boiler-steam": [
    ...
    { id:"bst-press",    emtAID:"60112", plnAID:"60112", name:"Steam Pressure",            cat:"Pressure", controlsId: "CTL-DEV-PRESS-STEAM",    def:true,  desc:"Boiler steam pressure + cable" },
    { id:"bst-sup-t",    emtAID:"60076", plnAID:"60076", name:"Steam Supply Temp",         cat:"Temperature", controlsId: "CTL-DEV-TEMP-STEAM", def:false, desc:"Steam supply temp sensor" },
  ...
  "pumping-chw": [
    ...
    { id:"pchw-vfd1",     emtAID:"60129", plnAID:"60129", name:"CHW Pump 1 VFD",           cat:"Drives", controlsId: "CTL-DEV-VFD-INTERFACE",      def:true,  desc:"VFD on primary CHW pump" },
    { id:"pchw-vfd2",     emtAID:"60129", plnAID:"60129", name:"CHW Pump 2 VFD",           cat:"Drives", controlsId: "CTL-DEV-VFD-INTERFACE",      def:false, desc:"VFD on secondary CHW pump" },
    { id:"pchw-dp",       emtAID:"60100", plnAID:"60100", name:"CHW Diff Pressure",        cat:"Pressure", controlsId: "CTL-DEV-PRESS-DP-SYS",    def:true,  desc:"Differential pressure across CHW system" },
    { id:"pchw-sup-t",    emtAID:"60076", plnAID:"60076", name:"CHW Supply Temp",          cat:"Temperature", controlsId: "CTL-DEV-TEMP-PIPE", def:true,  desc:"Chilled water supply temp" },
    { id:"pchw-ret-t",    emtAID:"60076", plnAID:"60076", name:"CHW Return Temp",          cat:"Temperature", controlsId: "CTL-DEV-TEMP-PIPE", def:true,  desc:"Chilled water return temp" },
  ...
  "pumping-hw": [
    ...
    { id:"phw-vfd1",     emtAID:"60129", plnAID:"60129", name:"HW Pump 1 VFD",             cat:"Drives", controlsId: "CTL-DEV-VFD-INTERFACE",      def:true,  desc:"VFD on primary HW pump" },
    { id:"phw-vfd2",     emtAID:"60129", plnAID:"60129", name:"HW Pump 2 VFD",             cat:"Drives", controlsId: "CTL-DEV-VFD-INTERFACE",      def:false, desc:"VFD on secondary HW pump" },
    { id:"phw-dp",       emtAID:"60100", plnAID:"60100", name:"HW Diff Pressure",          cat:"Pressure", controlsId: "CTL-DEV-PRESS-DP-SYS",    def:true,  desc:"Differential pressure across HW system" },
    { id:"phw-sup-t",    emtAID:"60076", plnAID:"60076", name:"HW Supply Temp",            cat:"Temperature", controlsId: "CTL-DEV-TEMP-PIPE", def:true,  desc:"Hot water supply temp" },
    { id:"phw-ret-t",    emtAID:"60076", plnAID:"60076", name:"HW Return Temp",            cat:"Temperature", controlsId: "CTL-DEV-TEMP-PIPE", def:true,  desc:"Hot water return temp" },
  ...
  "pumping-cond": [
    ...
    { id:"pcw-vfd1",     emtAID:"60129", plnAID:"60129", name:"CW Pump 1 VFD",             cat:"Drives", controlsId: "CTL-DEV-VFD-INTERFACE",      def:false, desc:"VFD on primary condenser pump" },
    { id:"pcw-sup-t",    emtAID:"60076", plnAID:"60076", name:"CW Supply Temp",            cat:"Temperature", controlsId: "CTL-DEV-TEMP-PIPE", def:true,  desc:"Condenser water supply temp" },
    { id:"pcw-ret-t",    emtAID:"60076", plnAID:"60076", name:"CW Return Temp",            cat:"Temperature", controlsId: "CTL-DEV-TEMP-PIPE", def:true,  desc:"Condenser water return temp" },
