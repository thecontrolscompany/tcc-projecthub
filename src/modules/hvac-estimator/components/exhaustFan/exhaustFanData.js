export const EXHAUST_FAN_COMPS = [
  ...
  { id: "ef-vfd", emtAID: "60129", plnAID: "60129", name: "Exhaust Fan VFD", cat: "Drives", controlsId: "CTL-AO", def: false, desc: "Variable frequency drive for exhaust fan speed control" },
];
