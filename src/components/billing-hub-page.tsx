  ...
  return (
    <div className="space-y-6">
      <section className="flex flex-wrap items-end justify-between gap-4">
        <div>
          <p className="text-sm font-medium uppercase tracking-wide text-brand-primary">BillingHub Overview</p>
          <h2 className="mt-1 text-3xl font-bold text-text-primary">{monthLabel}</h2>
          <p className="mt-2 max-w-2xl text-sm text-text-secondary">
            Current billing, billing history, and project billing signals in one place.
          </p>
        </div>
      ...
      <section className="grid gap-4 xl:grid-cols-[minmax(0,1.35fr),minmax(360px,0.65fr)]">
        ...
        <div className="space-y-4">
          ...
          <div className="rounded-2xl border border-border-default bg-surface-raised p-5">
            <h3 className="text-lg font-semibold text-text-primary">Related Workspaces</h3>
            <div className="mt-4 grid gap-2">
              <ShortcutLink href="/people" label="People" />
              <ShortcutLink href="/ops" label="OperationsHub" />
              <ShortcutLink href="/admin/analytics" label="Billing Analytics" />
