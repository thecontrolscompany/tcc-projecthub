...
const NAV_LINKS = [
  ...
  { label: "Projects", href: "/projects", roles: ["admin", "pm", "lead", "estimator", "billing", "accounting", "executive"] },
  { label: "PM Updates", href: "/pm", roles: ["admin", "pm", "lead"] },
  { label: "Installer Portal", href: "/installer", roles: ["installer"] },
  { label: "Operations", href: "/ops", roles: ["ops_manager"] },
